...
let gameState2 = "play2";
let spawnInterval2 = 3000;
...
let gameOverTriggered2 = false;
let gameOverTimer2 = 0;
let fadeAmount2 = 0;
let resultState2 = "";
...
// ★ 수정: 선언 시 기본값 0 → setup 전에 draw가 호출돼도 NaN 방지
let frontLineX = 0;
let gameOver = false;
const DEAD_LINE = 120;
let bossDead = false;
...
// ★ 핵심 수정: layer를 0~frontLineX 범위로 그림 (전선 왼쪽을 덮는 효과)
...
function defend2() {
  ...
  guardSuccess2 = true;
  showMessage2("방어했다!");
  setTimeout(() => { guardSuccess2 = false; }, 1000);
}
